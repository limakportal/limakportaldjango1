...
class PersonIdentity(models.Model):
    ...
    PlaceOfBirthCityId = models.ForeignKey(City,on_delete=models.CASCADE,related_name='PlaceOfBirthCityId')
    PlaceOfBirthDistrictId = models.ForeignKey(District,on_delete=models.CASCADE,related_name='PlaceOfBirthDistrictId')
    RegisteredCityId = models.ForeignKey(City,on_delete=models.CASCADE,related_name='RegisteredCityId')
    RegisteredDistrictId = models.ForeignKey(District,on_delete=models.CASCADE,related_name='RegisteredDistrictId')
    BirthDate = models.DateField(blank=True, null=True)
    GenderId = models.ForeignKey(Gender,on_delete=models.CASCADE,blank=True, null=True)
    MaritalStatusId = models.ForeignKey(MaritalStatus,on_delete=models.CASCADE,blank=True, null=True)
