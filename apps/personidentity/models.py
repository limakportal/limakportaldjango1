...
class PersonIdentity(models.Model):
    ...
    PlaceOfBirthCity = models.ForeignKey(City,on_delete=models.CASCADE,related_name='PlaceOfBirthCityId')
    PlaceOfBirthDistrict = models.ForeignKey(District,on_delete=models.CASCADE,related_name='PlaceOfBirthDistrictId')
    RegisteredCity = models.ForeignKey(City,on_delete=models.CASCADE,related_name='RegisteredCityId')
    RegisteredDistrict = models.ForeignKey(District,on_delete=models.CASCADE,related_name='RegisteredDistrictId')
